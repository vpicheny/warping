...
we conducted 50 independent optimizations of sharka management parameters with and without the warping step. \coralie{mettre ici quel type de warping on a utilise} The criterion to optimize was the mean of the NPV ($\overline{NPV}$).
...
Secondly, we used a specific algorithm using empirical distribution functions \cite{hansen2010}. Briefly, we uniformly defined 100 $\alpha$ values between a minimum and a maximum values. 
