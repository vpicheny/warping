...
$\zeta_{eO}, \zeta_{f}$ and $\zeta_{s}$. On all cases, we used a Matern 5/2 correlation-based warping. 

The criterion to optimize was the mean of the NPV ($\overline{NPV}$).
